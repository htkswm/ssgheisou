...
(function () {
  ...
  var fs = [
    ...
    '  float sd=length(sp-pos); float sz=0.13+0.13*hash(cell+3.7);',
    '  float star=(smoothstep(sz,0.0,sd)+smoothstep(sz*2.6,0.0,sd)*0.22)*step(0.90,r0)*(0.55+0.45*sin(u_time*1.7+r0*60.0))*smoothstep(0.25,0.85,uv.y);',
    '  vec3 starC=vec3(1.0,0.93,0.85)*star*0.9;',
